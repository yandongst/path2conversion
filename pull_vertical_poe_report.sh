...
hadoop fs -text /projects/science/output/merged/userevents_adlogs_retarg_cnt/vertical/${timeperiod}/$fn/part-0000*.gz|python metrics_adlift.py > tmp.txt
cat tmp.txt|python add_adgroup_name.py > ${fn_output}
